...
import com.example.tourisminukraine.Adapter.MyCommentAdapter;
import com.example.tourisminukraine.Callback.ICommentCallbackListener;
...
public class CommentFragment extends BottomSheetDialogFragment implements ICommentCallbackListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        commentViewModel.getMutableLiveDataPlaceList().observe(this, commentModels -> {
